...
export default function Abstract({ abstract }: Props) {
    ...
    if (!expanded) {
        return (
            <>
                <div className="mt-2 text-sm leading-normal text-justify line-clamp-3 prose prose-dante dark:prose-dark">
    ...
    return (
        <>
            <div className="mt-2 text-sm leading-normal text-justify prose prose-dante dark:prose-dark">
              <Markdown>{abstract}</Markdown>
            </div>
